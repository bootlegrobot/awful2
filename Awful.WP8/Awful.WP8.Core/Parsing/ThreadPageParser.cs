...
namespace Awful
{
    public static class ThreadPageParser
    {
        ...
        */
        ...
        {
            KSDebugger.AddLog(top,  KSDebugger.Level.Debug, "Parsing HTML for posts...");
        ...
        private static ThreadPageMetadata ParsePostTable(this ThreadPageMetadata page, HtmlNode top)
        {
            ...
            KSDebugger.AddLog(top, KSDebugger.Level.Debug, "Parsing post data...");
            ...
            KSDebugger.AddLog(top, KSDebugger.Level.Debug, "Thread page parsing complete.");
        ...
        private static ThreadPageMetadata ParsePageNumberAndMaxPages(this ThreadPageMetadata page, HtmlNode top)
        {
            ...
            KSDebugger.AddLog(top, KSDebugger.Level.Debug, "Parsing page number...");
            ...
            if (currentPageNode != null)
            {
                ...
                KSDebugger.AddLog(top, KSDebugger.Level.Debug, "Parsing total number of pages...");
            ...
            {
                KSDebugger.AddLog(top, KSDebugger.Level.Debug, "Page number parsing failed.");
                // set page number
                page.PageNumber = 1;
                page.LastPage = 1;
            }
